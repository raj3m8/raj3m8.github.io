<?php 
function  easyweb_webnus_maxslider_shortcode($attributes, $content)
{
    ...
    if(!empty($id))
     $out = '</div></section><section id="'.$id.'" class="max-hero maxslider '. $class .'">';
    else  
     $out = '</div></section><section class="max-hero maxslider '. $class .'">';
...
add_shortcode("maxslider", 'easyweb_webnus_maxslider_shortcode');
?>